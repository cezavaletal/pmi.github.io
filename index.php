        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                   <h1 class="hero-title">PMI Trujillo Participara del Tour Cono Sur</h1>
                   <p class="hero-text"><strong>Tour Cono Sur es uno de los eventos mas grandes del País</strong> </p>
                   <a href="#" class="btn btn-default">Ver Mas..</a> </div>
            </div>
        </div>
    </div>
    </div>
...
Construya una red profesional </p>
                    <a href="https://easetemplate.com/downloads/category/free-website-template/" class="btn btn-default" target="_blank">Ver Mas..</a> </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6">
                                <div class="post-content">
                                    <h2><a href="https://easetemplate.com/" class="title" target="_blank">Tenemos para profesionales, estudiantes y jubilados.</a></h2>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            ...
                            <ul class="listnone contact">
                                <li><i class="fa fa-map-marker"></i>Francisco Borja 250, Victor Larco Herrera 13008 </li>
                                <li><i class="fa fa-phone"></i> (044) 608395</li>
                                <li><i class="fa fa-fax"></i> </li>
                                <li><i class="fa fa-envelope-o"></i> pmitrujillo@pmicajamarca.com</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="footer-widget widget-newsletter">
                            ...
                            <h2 class="widget-title">Newsletters</h2>
                              <p>Ingrese su dirección de correo electrónico para recibir nueva información del la comunidad y
                               otra información útil directamente en su bandeja de entrada.</p>
